    ...
    <>
      <div className="flex items-center justify-between border-b px-4 py-2">
        ...
        <div className="flex items-center space-x-1">
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8 p-0" onClick={() => setIsTerminalOpen(true)}>
      ...
      <FloatingTerminal server={server} isOpen={isTerminalOpen} onClose={() => setIsTerminalOpen(false)} />
    </>
  );
}
