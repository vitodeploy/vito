...
import OfficialPlugins from '@/pages/legacy-plugins/components/official';
import InstalledPlugins from '@/pages/legacy-plugins/components/installed';
import { LegacyPlugin } from '@/types/plugin';
import CommunityPlugins from '@/pages/legacy-plugins/components/community';
...
export default function Plugins() {
  ...
  return (
    <SettingsLayout>
      <Head title="Legacy Plugins" />

      <Container className="max-w-5xl">
        <div className="flex items-start justify-between">
          <Heading title="Legacy Plugins" description="Here you can install/uninstall legacy plugins" />
