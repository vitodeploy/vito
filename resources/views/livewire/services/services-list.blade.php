            ...
            <x-dropdown>
                ...
                <x-slot name="content">
                    <x-dropdown-link
                        ...
                        x-on:click="$dispatch('open-modal', 'install-phpmyadmin')"
                    >
                        {{ __("PHPMyAdmin") }}
                    </x-dropdown-link>
                </x-slot>
                    ...
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            ...
                            @else
                                <x-dropdown-link
                                    class="cursor-pointer"
                                    wire:click="uninstall({{ $service->id }})"
                                >
                                    {{ __("Uninstall") }}
                                </x-dropdown-link>
                            @endif
